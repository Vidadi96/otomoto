...
$(document).ready(function(){
    ...
    if($(window).width()>=768){
        $(".now-change").click(function(){
            ...
            $('html,body').animate({
                ...
                if($(".category-details").length>0 && $(".category-details").css("display")=="block"){
    ...
    if($(window).width()<768){
        ...
        $(".second-category .select").click(function(e){
            ...
            $(".second-category>.second-mobile .models").css("display","none");
        });
...
function ChangeNotSub(sub,sc){
    ...
    else if(subcategory=="Mənzillər"){
        $("#details").css("display","block");
    }
    else if(subcategory=="Villalar, bağ evləri"){
        $("#details").css("display","block");
    }
    else if(subcategory=="Torpaq"){
        $("#details").css("display","block");
    }
    else{
        $("#details").css("display","none");
...
function ChangeSecond(ss,sc){
    ...
    $(".second-category>.third-modal .selected").removeClass("selected");
    $(this).addClass("selected");
...
function ChangeThird(ts,sc){
    ...
    $(".third-category>.third-modal .selected").removeClass("selected");
    $(this).addClass("selected");
...
if($(window).width()>=768){
    ...
    $(".second-category>.second-modal .subcategory").click(function(){
        $(".second-category>.second-modal .subcategories").removeClass("column-active");
        $(".second-category>.second-modal .selected").removeClass("selected");
        $(this).addClass("selected");
        $(".second-category>.second-modal .models").addClass("column-active");
        $(".second-category>.second-modal .models").css("display","block");
