  ...
  /*============Start Avtive/Passive Script============*/
			$(".set_active_passive").on("click", function(){
					...
					$.post(url,
					{
						...
						otomoto:$("input[name=otomoto]").val(),
						method: "ajax"
					},function(data)
					{
						var obj = $.parseJSON(data);
            $("input[name=otomoto]").val(obj.otomoto);
      ...
      /*============Start Avtive/Passive 2 Script============*/

    			$(".set_active_passive2").on("click", function(){
    					var id = $(this).attr("id");
    					var current_button = $(this);
    					var active_passive = $(this).attr("active_passive");
    					var url= $(this).closest("table").attr("active_passive_url2");
    					//$(".loader").fadeIn(200);
    					$.post(url,
    					{
    						id: id,
          ...
          /*============Start Avtive/Passive 3 Script============*/

        			$(".set_active_passive3").on("click", function(){
        					var id = $(this).attr("id");
        					var current_button = $(this);
        					var active_passive = $(this).attr("active_passive");
        					var url= $(this).closest("table").attr("active_passive_url3");
        					//$(".loader").fadeIn(200);
        					$.post(url,
        					{
        						id: id,
