	...
	$.fn.FancyFileUpload = function(options) {
		...
		var AddFile = function(uploads, e, data) {
			...
			var StartUpload = function(e) {
				...
				inforow.find('button.ff_fileupload_remove_file').attr('aria-label', Translate('Cancel upload and sil'));
			...
			if (haspreview)
			{
				inforow.find('.ff_fileupload_preview_image').addClass('ff_fileupload_preview_image_has_preview').attr('aria-label', Translate('Baxış')).click(function(e) {
					e.preventDefault();
			...
			inforow.find('.ff_fileupload_actions').append($('<button>').addClass('ff_fileupload_remove_file').attr('type', 'button').attr('aria-label', Translate('Sil')).click(RemoveFile));
			inforow.find('.ff_fileupload_actions_mobile').append($('<button>').addClass('ff_fileupload_remove_file').attr('type', 'button').attr('aria-label', Translate('Sil')).click(RemoveFile));
		...
		var UploadFailed = function(e, data) {
			...
			else
			{
				...
				// Alter remove buttons.
				data.ff_info.inforow.find('button.ff_fileupload_remove_file').attr('aria-label', Translate('Sil'));
			}
		};
		...
		var UploadDone = function(e, data) {
			...
			{
				// Set the status.
				data.ff_info.inforow.find('.ff_fileupload_fileinfo').text(data.ff_info.displayfilesize + ' | ' + Translate('Uğurla tamamlandı'));
