...
?>
        ...
        if(!$search): ?>
            <div class="categories-container">
                <div class="container">
                    <div class="category-eds owl-carousel">
                        <a class="category-ed ca1" href="http://avis.az" target="_blank">
                            <img src="/Images/avis.png" class="d-md-block">
                        </a>
                        <a class="category-ed ca2" href="https://ant.az" target="_blank">
                            <img src="/Images/ant.jpg" class="d-md-block">
                        </a>
                        <a href="https://texnoshop.az" target="_blank" class="category-ed ca3">
                            <img src="/Images/texnoshop.png" class="d-md-block">
                        </a>
                        <a class="category-ed ca4" href="https://istikbal.com.az" target="_blank">
                            <img src="/Images/istikbal.png" class="d-md-block">
                        </a>
                        <a class="category-ed ca5" href="https://estelita.az" target="_blank">
                            <img src="/Images/estelita.png" class="d-md-block">
                        </a>
                    </div>
                </div>
            </div>
        <?php endif; endif;?>
        <div class="mobile_show2 mobile_banner">
          <video width="320" height="240" controls poster="/assets/img/otomoto.jpeg">
            <source src="/assets/img/otomoto_video_2.mp4" type="video/mp4">
            Your browser does not support the video tag.
          </video>
        </div>
        <!-- <div class="relative_100 mobile_show_block">
        ...
        <div class="container category_container">
            <div class="category_div">
                ...
                <a href="/pages/index?search=1" class="cat_cont <?=(isset($all_ads) && $all_ads)?'all_ads':''; ?>">
                    <div class="circle_category_div all_ads_div"></div>
                    <span>Bütün elanlar</span>
                    <p class="mobile_text2">Bölümü seç</p>
                </a>
                <a href="/pages/rent_car" target="_blank" class="cat_cont">
    ...
    <main>
                    ...
                    <div class="filter_div">
                        <div class="filter_line">
                            ...
                            <label class="cred_bart">
                              Kredit
                              <input type="checkbox" class="filter_checkbox" name="credit" <?=$filter_credit?'checked':''; ?>>
                            </label>
                        ...
                        <div class="filter_line">
                            ...
                            <label class="cred_bart">
                              Barter
                              <input type="checkbox" class="filter_checkbox" name="barter" <?=$filter_barter?'checked':''; ?>>
                            </label>
                            <span class="total_span"><?//=$total_row; ?></span>
                            <a href="/pages/detailed_search?<?=$_SERVER['QUERY_STRING']; ?>" class="full_search_button">Ətraflı axtarış</a>
                        </div>
                    </div>
                </div>
            </form>
            <div class="filter_mobile">
                <form action="/pages/index" method="get">
                    <div class="filter_row">
                      <div class="for_filter_button">
                        <button type="button" style="text-align: left; border: 1px solid #dadfe3; color: #6f7d8d;" class="btn btn-default filter_button"><?=(isset($filter_mark_name) && $filter_mark_name)?($filter_model_name?$filter_mark_name->mark.' '.$filter_model_name->model:$filter_mark_name->mark):'Bütün markalar'; ?></button>
                ...
                <div id="drag" class="filter_row2">
                  <?php foreach ($popular_mark as $row): ?>
                    <div class="mark_list" data="<?=$row->id; ?>">
                      <img src="<?=$row->img?'/assets/img/car_marks/small/'.$row->img:'/assets/img/car_photos/logo/nophoto.png'; ?>">
                      <span><?=$row->mark; ?></span>
                    </div>
                  <?php endforeach; ?>
                </div>
                ...
                <div class="filter_row3">
                  <a href="/pages/detailed_search?<?=$_SERVER['QUERY_STRING']; ?>" class="full_search_mobile btn btn-danger">
            ...
            <section class="premium_ads super-eds-container sec ">
                <div class="container">
                    <div class="super-eds">
                      <a href="/pages/top?top=1&<?=$_SERVER['QUERY_STRING']; ?>">
                          ...
                          <div class="super-ed-container pb-0" style="width: 100%;">
                            <?php foreach ($premium_list as $row):
                              ...
                              <div class="super-ed post">
                                  <a href="/pages/product/<?=$url; ?>" class="super-ed-image">
            ...
            <section class="premium_ads super-eds-container mt-20">
                <div class="container">
                    <div class="super-eds">
                      <a href="/pages/top?top=0&<?=$_SERVER['QUERY_STRING']; ?>">
                        <div class="super-ed-text">
                            <p>
    ...
    <section class="premium_ads latest-ads-container">
        <div class="container">
            <div class="super-eds">
                  <div class="super-ed-text">
                      <a href="/pages/simple?<?=$_SERVER['QUERY_STRING']; ?>">
                        <p>
                            <b style="border-bottom: 3px solid #e53238; padding-bottom: 3px;">Son Elanlar</b>
                            <span class="top_link mobile_show_block">Hamısına bax<i class="fa fa-external-link" aria-hidden="true"></i></span>
                        </p>
                      </a>
