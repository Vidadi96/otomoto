...
<div class="row">
    <div class="new-car-wrapper">
      ...
      <div class="row">
        ...
        <form class="addNewCar" action="/rent/do_edit_rent_car" method="post">
          ...
          <div class="row">
              ...
              <div class="my-form-group form-inline">
                <select class="form-control custom-width my_add_car_style" required id="class" name="class">
                  ...
                  <?php foreach($classes as $row): ?>
                    <option <?=($editAd[0]['class'] == $row->id)?'selected':''; ?> value="<?=$row->id; ?>"><?=$row->class; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="my-form-group form-inline">
                <input type="number" class="form-control custom-width my_add_car_style" id="included_km" required min="0" step="1" name="included_km" value="<?=($editAd[0]['included_km'])?$editAd[0]['included_km']:''?>">
              </div>
            </div>

            <div class="col-md-2">
              <label class="my_add_car_label_style" for="surcharge">Limit keçildikdə <span class="requiredSpan" >&nbsp;*&nbsp;&nbsp;</span></label>
            </div>
            <div class="col-md-4">
              <div class="my-form-group form-inline">
                <input type="number" class="form-control custom-width my_add_car_style" id="surcharge" required min="0" step="1" name="surcharge" value="<?=($editAd[0]['surcharge'])?$editAd[0]['surcharge']:''?>">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="my-form-group form-inline">
                <input type="number" class="form-control custom-width my_add_car_style" id="deposit" required min="0" step="1" name="deposit" value="<?=($editAd[0]['deposit'])?$editAd[0]['deposit']:''?>">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="my-form-group form-inline">
                <input type="number" class="form-control custom-width my_add_car_style" id="limitation" required min="0" step="1" name="limitation" value="<?=($editAd[0]['limitation'])?$editAd[0]['limitation']:''?>">
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="my-form-group form-inline">
                ...
                <label>&nbsp;<input type="radio"  <?=($editAd[0]['currency']==0)?'checked':''?> value="0"  checked name="currency">&nbsp;AZN</label>
                <label>&nbsp;<input type="radio" <?=($editAd[0]['currency']==1)?'checked':''?> value="1" name="currency">&nbsp;USD</label>
                <label>&nbsp;<input type="radio" <?=($editAd[0]['currency']==2)?'checked':''?> value="2" name="currency">&nbsp;EUR</label>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-2 checkbox-inline">
              <label for="delivery" style="width: 100%">
                ...
                <input type="checkbox" id="delivery" <?=($editAd[0]['delivery'])?'checked  value=1':''?> name="delivery">
                Çatdırılma
              </label>
              <label for="returning">
                <input type="hidden" value="0" name="returning">
                <input type="checkbox" id="returning" <?=($editAd[0]['returning'])?'checked  value=1':''?> name="returning">
                Geri götürmə
              </label>
            </div>
              ...
              <div class="row additional-param" >
                ...
                <div class="col-sm-3 col-md-3 col-lg-3 checkbox-inline">
                  <label for="baby_chair">
                    ...
                    <input type="checkbox" <?=($editAd[0]['baby_chair'])?'checked value=1':''?> class="my_checkbox_style" id="baby_chair" value="1" name="baby_chair"  >
                    Uşaq oturacağı
                  </label>
                </div>
                ...
                <div class="col-sm-3 col-md-3 col-lg-3 checkbox-inline">
                  <label for="roof_rack">
                    ...
                    <input type="checkbox" <?=($editAd[0]['roof_rack'])?'checked value=1':''?> class="my_checkbox_style" id="roof_rack" value="1" name="roof_rack"  >
                    Dam üstü baqaj
                  </label>
                </div>
                ...
                <div class="col-sm-3 col-md-3 col-lg-3 checkbox-inline">
                  <label for="insurance">
                    ...
                    <input type="checkbox" <?=($editAd[0]['insurance'])?'checked value=1':''?> class="my_checkbox_style" id="insurance" value="1" name="insurance"  >
                    Sığorta
                  </label>
                </div>
                  ...
                  <?php if(isset($carphotos)):
                    ...
                    <li id="<?=$val['id']; ?>"  data-order="<?=$val['id']; ?>" data-position="<?=@$val['location']; ?>" >
                      <div class="mini-image">
                        ...
                        <img class="for_preview_img mini-image" src="/assets/img/rent_car_photos/800xauto/<?=$val['name']?>" alt="">
                      </div>
                    </li>
                  <?php $i++; } endif; ?>
                </ul>
...
<script type="text/javascript">
    ...
    $('#demo').FancyFileUpload({
      ...
      url: '/rent/img_upload_main?set_active=1&pincode='+'<?=$editAd[0]['pincode'].'&carid='.$editAd[0]['id']; ?>',
  ...
  $(document).ready(function () {
   ...
   $(document).ready(function() {
     ...
     if (response == 1)
       toastr.success('Elanınız uğurla yoxlanışa göndərildi', 'Uğur');
   });
