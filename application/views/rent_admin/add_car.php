...
<div class="m-content">
    <!--begin::Form-->
    <form action="/rent_admin/add_car_func" method="POST" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row" style="">
                            ...
                            <div class="col-md-4">
                              ...
                              <input class="form-control" type="number" name="included_km" id="included_km" value="" required>
                            </div>
                            <div class="col-md-4">
                              <label for="surcharge">İcarə dövrünü keçdikdə</label>
                              <input class="form-control" type="number" name="surcharge" id="surcharge" value="" required>
                            </div>
                            <div class="col-md-4">
                              <label for="deposit">Depozit</label>
                              <input class="form-control" type="number" name="deposit" id="deposit" value="" required>
                            </div>
                            <div class="col-md-4">
                              <label for="limitation">Yürüşün məhdudlaşdırılması</label>
                              <input class="form-control" type="number" name="limitation" id="limitation" value="" required>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-check">
                                    <input class="form-check-input" name="returning" type="checkbox" id="returning">
                        ...
                        <div class="form-group m-form__group row">
                          ...
                          <div class="col-md-3">
                              <div class="form-check">
                                  <input class="form-check-input" name="baby_chair" type="checkbox" id="baby_chair">
                                  <label class="form-check-label" for="baby_chair">Uşaq oturacağı</label>
                              </div>
                          </div>
                          <div class="col-md-3">
                              <div class="form-check">
                                  <input class="form-check-input" name="roof_rack" type="checkbox" id="roof_rack">
