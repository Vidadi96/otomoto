...
<div class="m-subheader ">
	<div class="d-flex align-items-center">
		...
		<a class="btn btn-success pull-right" href="/cars/add_car/"><i class="fa fa-plus"></i>Yeni elan</a>
	</div>
</div>
<!-- END: Subheader -->
	<div class="m-content">
                    ...
                    <div class="col-lg-3">
                      ...
                      <select id="status" name="status" class="form-control">
                        ...
                        <option <?=($status == 4)?'selected':''; ?> value="4">Silinmiş</option>
    						...
    						<div class="row">
    							<div class="col-xl-12">
    								<table delete_url="/cars/delete_car/" class="table table-bordered m-table">
    									<thead>
    										<tr>
    											<th>Şəkil</th>
    											<th>Model</th>
                          ...
                          foreach ($car_list as $row):?>
    											  <tr>
                              <td>
                                <img src="<?=($row->image)?'/assets/img/car_photos/90x90/'.$row->image:''; ?>" width="50" height="50">
                              </td>
                              <td><?=$row->mark.' '.$row->model; ?></td>
                              <td><?=$row->user; ?></td>
                              <td><?php if($row->agreement)
                              ...
                              <td>
                                <a href="/cars/edit_car/<?=$row->id; ?>" target="_blank" class="btn btn-info btn-sm m-btn m-btn--icon m-btn--icon-only">
