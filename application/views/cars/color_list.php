...
<!-- END: Subheader -->
	<div class="m-content">
        ...
        <?php if(isset($status)): ?>
                ...
                <form action="/cars/add_color" method="post">
                  ...
                  <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <textarea id="color" name="color" class="form-control" required></textarea>
          ...
          <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
              <div class="m-portlet__head-title">
                ...
                <h3 class="m-portlet__head-text">
                  Avtomobilin rəngləri
                </h3>
              </div>
            </div>
          </div>
          <div class="m-portlet__body">
            <table delete_url="/cars/delete_color/" class="table table-bordered m-table"  active_passive_url="/cars/active_passive_color/">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Rəng</th>
