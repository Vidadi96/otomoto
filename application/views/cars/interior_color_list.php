...
<!-- END: Subheader -->
	<div class="m-content">
        ...
        <?php if(isset($status)): ?>
                ...
                <form action="/cars/add_interior_color" method="post">
                  ...
                  <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label for="interior_color">Salonun rəngi</label>
                        <textarea id="interior_color" name="interior_color" class="form-control" required></textarea>
												<span class="m-form__help">Misal üçün: <i>Sarı,Yaşıl</i></span>
                      </div>
                    </div>
        ...
        <div class="m-portlet m-portlet--accent m-portlet--head-solid-bg m-portlet--head-sm" m-portlet="true" id="m_portlet_tools_2">
          ...
          <div class="m-portlet__body">
            <table delete_url="/cars/delete_interior_color/" class="table table-bordered m-table"  active_passive_url="/cars/active_passive_interior_color/">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Rəng</th>
