...
<!-- END: Subheader -->
	<div class="m-content">
        ...
        <?php if(isset($status)): ?>
                ...
                <form action="/cars/add_carbody" method="post">
                  ...
                  <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label for="carbody">Ban növü</label>
                        <input type="text" id="carbody" name="carbody" class="form-control m-input" required>
                      </div>
                    </div>
        ...
        <div class="m-portlet m-portlet--accent m-portlet--head-solid-bg m-portlet--head-sm" m-portlet="true" id="m_portlet_tools_2">
          ...
          <div class="m-portlet__body">
            <table delete_url="/cars/delete_carbody/" class="table table-bordered m-table"  active_passive_url="/cars/active_passive_carbody/">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Ban növü</th>
